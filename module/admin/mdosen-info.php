...
<div class="card-title mb-4">
    ...
    <a class="btn btn-success editbtn"  href="index?page=mdosen_edit&id=<?php echo $data['nidn'] ?>">
      <i class="fa fa-edit"></i> Edit</a>
  <a class="btn btn-danger" onclick="return confirm('Yakin Data Akan Dihapus?')" href="controller?page=hapus_mdosen&id=<?php echo $data['nidn'] ?>">
  ...
  <div class="card-body">
    <div class="tab-content" id="custom-tabs-two-tabContent">
      ...
      <div class="tab-pane fade show" id="custom-tabs-two-j1" role="tabpanel" aria-labelledby="custom-tabs-two-j1-tab">
        <a style="width:150px;"  class="btn btn-primary btn-block" href="index?page=mdosen_pendidikan_add&id=<?php echo $data['nidn'] ?>"><i class="fa fa-plus"></i>Tambah Data</a><br>
        <div class="table-responsive">
      ...
      <div class="tab-pane fade show" id="custom-tabs-two-j2" role="tabpanel" aria-labelledby="custom-tabs-two-j2-tab">
        <a style="width:150px;"  class="btn btn-primary btn-block" href="index?page=mdosen_jabatan_add&id=<?php echo $data['nidn'] ?>"><i class="fa fa-plus"></i>Tambah Data</a><br>
        ...
        <tr>
          ...
          <td>
            <a class="btn btn-danger" href="controller?page=hapus_jabatan&id=<?php echo $data2['id_jb'] ?>">
              <i class="fa fa-trash"></i></a>
          </td>
        </tr>
            <?php
      ...
      <div class="tab-pane fade show" id="custom-tabs-two-j3" role="tabpanel" aria-labelledby="custom-tabs-two-j3-tab">
        ...
        if (mysqli_num_rows($btnt) == 0)  {
          echo "<a style='width:150px;' class='btn btn-primary btn-block' href='index?page=mdosen_pangkat_add&id=$data[nidn]'><i class='fa fa-plus'></i>Tambah Data</a><br>";
        }
        else {
          echo "";
        };
        ...
        <tr>
          ...
          <td>
            <a class="btn btn-danger" href="controller?page=hapus_pangkat&id=<?php echo $data3['id_pk'] ?>">
              <i class="fa fa-trash"></i></a>
          </td>
        </tr>
            <?php
      ...
      <div class="tab-pane fade show" id="custom-tabs-two-j4" role="tabpanel" aria-labelledby="custom-tabs-two-j4-tab">
        <a style="width:150px;"  class="btn btn-primary btn-block" href="index?page=mdosen_skp_add&id=<?php echo $data['nidn'] ?>"><i class="fa fa-plus"></i>Tambah Data</a><br>
        <div class="table-responsive">
        <table class="table table-hover table-striped text-nowrap">
        <thead>
        <tr>
        ...
        <tr>
          ...
          <td>
            <a class="btn btn-danger" href="controller?page=hapus_skp&id=<?php echo $data4['id_skp'] ?>">
              <i class="fa fa-trash"></i></a>
          </td>
        </tr>
            <?php
      ...
      <div class="tab-pane fade show" id="custom-tabs-two-j5" role="tabpanel" aria-labelledby="custom-tabs-two-j5tab">
        <a style="width:150px;"  class="btn btn-primary btn-block" href="index?page=mdosen_kgb_add&id=<?php echo $data['nidn'] ?>"><i class="fa fa-plus"></i>Tambah Data</a><br>
        <div class="table-responsive">
        <table class="table table-hover table-striped text-nowrap">
        <thead>
        <tr>
        ...
        <tr>
          ...
          <td>
            <a class="btn btn-danger" href="controller?page=hapus_kgb&id=<?php echo $data5['id_kgb'] ?>">
              <i class="fa fa-trash"></i></a>
          </td>
        </tr>
            <?php
      ...
      <div class="tab-pane fade show" id="custom-tabs-two-j6" role="tabpanel" aria-labelledby="custom-tabs-two-j6-tab">
        <a style="width:150px;"  class="btn btn-primary btn-block" href="index?page=mdosen_lh_add&id=<?php echo $data['nidn'] ?>"><i class="fa fa-plus"></i>Tambah Data</a><br>
        <div class="table-responsive">
        <table class="table table-hover table-striped text-nowrap">
        <thead>
        <tr>
        ...
        <tr>
          ...
          <td>
            <a class="btn btn-danger" href="controller?page=hapus_lh&id=<?php echo $data6['id_lh'] ?>">
              <i class="fa fa-trash"></i></a>
          </td>
        </tr>
            <?php
      ...
      <div class="tab-pane fade show" id="custom-tabs-two-j7" role="tabpanel" aria-labelledby="custom-tabs-two-j7-tab">
        ...
        if (mysqli_num_rows($btnt) == 0)  {
          echo "<a style='width:150px;' class='btn btn-primary btn-block' href='index?page=mdosen_dp_add&id=$data[nidn]'><i class='fa fa-plus'></i>Tambah Data</a><br>";
        }
        else {
          echo "";
        };
