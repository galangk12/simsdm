...
<div style='overflow-x:auto;'>
    <table >
    <td><a style='width:150px;padding:5px;' class='btn btn-success' href='rekapan/rekapan_rtendik'><i class='fa fa-book'></i> Export Excel</a></td>
    <td><a style='width:150px;padding:5px;' class='btn btn-danger' href='#' target='_blank'><i class='fa fa-book'></i> Export PDF</a></td>
    </table>
  </div>
...
<tbody>
  <?php
    $query = "SELECT * FROM tb_pendaftar WHERE jalur='TENDIK'";
