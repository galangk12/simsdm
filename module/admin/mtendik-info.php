...
JOIN tb_mda_fak b ON a.fak = b.id_fak where nik = '$nik'";
...
<div class="card-title mb-4">
    ...
    <a class="btn btn-primary editbtn"  href="rekapan/absen_tendik?nik=<?php echo $data['nik'] ?>" target="_blank">
      <i class="fa fa-book"></i> Rekap Absen</a>
    <a class="btn btn-success editbtn"  href="index?page=mtendik_edit&id=<?php echo $data['nik'] ?>">
      <i class="fa fa-edit"></i> Edit</a>
  <a class="btn btn-danger" onclick="return confirm('Yakin Data Akan Dihapus?')" href="controller?page=hapus_mtendik&id=<?php echo $data['nik'] ?>">
