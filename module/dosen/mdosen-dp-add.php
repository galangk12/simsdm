...
<div class="card card-danger card-tabs" style="width:100%">
	<div class="card-header p-0 pt-1">
      ...
      <div class="card-body">
            ...
            <form class="" action="controller.php?page=tambah_mdosen_dp" method="post" enctype="multipart/form-data" onsubmit="return Validate(this);">
              <div class="container-fluid">
                  <div class="row">
                  ...
                  <div class="input-group mb-3">
					...
					<tr>
						...
						<td>
					<div class="input-group mb-3">
						<input placeholder="Sertifikat Pendidik" type="file" class="form-control" name="sp" required>
					</div>
				</td>
			</tr>
			<tr>
