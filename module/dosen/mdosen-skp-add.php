...
<div class="card card-danger card-tabs" style="width:100%">
	<div class="card-header p-0 pt-1">
		<ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
			...
			<li class="nav-item">
				<a class="nav-link active" id="custom-tabs-two-js-tab" data-toggle="pill" href="#custom-tabs-two-js" role="tab" aria-controls="custom-tabs-two-js" aria-selected="true">Tambah Berkas SKP</a>
			</li>
    </div>
  </div>
      <div class="card-body">
            ...
            <form class="" action="controller?page=tambah_mdosen_skp" method="post" enctype="multipart/form-data" onsubmit="return Validate(this);">
              <div class="container-fluid">
                  <div class="row">
                  ...
                  <tr>
                    ...
                    <td>
                  <div class="input-group mb-3">
                    <input placeholder="Berkas SKP" type="file" class="form-control" name="berkas_skp" required>
                  </div>
                </td>
              </tr>
</table>
