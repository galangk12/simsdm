...
$awalmasuk = new DateTime('07:00');
$akhirmasuk = new DateTime('11:00');
$awalpulang = new DateTime('12:00');
$akhirpulang = new DateTime('17:00');
$sekarang = date("Y-m-d");
$qr=mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM absen_tendik where nik='$nik' and tanggal='$sekarang'"));
...
if($now >= $awalmasuk && $now <= $akhirmasuk){
    ...
    if(isset($qr['jam_masuk']) && $now < $awalpulang) {
        ...
        Anda Telah Melakukan Absensi Masuk. Terimakasih
            ...
            echo '<a href="controller?page=absenmasuktendik&nik='.$nik.'&code='.$code.'" class="btn btn-primary">Absen Masuk <i class="fa fa-sign-in"></i></a><br>';
        }
    ...
    if(isset($qr['jam_pulang']) && $now <= $akhirpulang) {
        ...
        Anda Telah Melakukan Absensi Pulang. Terimakasih
            ...
            echo '<a href="controller?page=absenpulangtendik&nik='.$nik.'&code='.$code.'" class="btn btn-danger"><i class="fa fa-sign-out"></i> Absen Pulang</a><br>';
        }
...
<?php 
$qr=mysqli_query($conn,"SELECT * FROM absen_tendik where nik='$nik'");
...
<?php
    ...
    echo "<center>Maaf Kode Invalid</center>";
}
?>